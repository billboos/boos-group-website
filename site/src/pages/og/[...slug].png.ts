...
export async function getStaticPaths() {
  ...
  const pages = [
    ...
    { slug: 'about', title: 'About', subtitle: 'About the group' },
...
export async function GET({ params, props }: { params: any; props: any }) {
  ...
  const icons: Record<string, string> = {
    ...
    opportunities: "M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z", // User Plus
    about: "M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z", // Info
    "data-tools": "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z", // Monitor
  };
