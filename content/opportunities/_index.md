...
Prospective students who are interested in this opportunity are encouraged to apply to the [EPS Graduate Program](https://eps.berkeley.edu/admissions).  I will arrange video calls with a subset of candidates after applications are reviewed (typically in January and February).  I likely do not have the capacity to correspond or meet before the application deadline, but I encourage you to [email me](mailto:william.boos@berkeley.edu) to let me know your application is coming.  Any manuscript drafts, project reports, or similar writing samples that you can submit will be helpful; you can include these with your formal application or send them to me separately by email.
